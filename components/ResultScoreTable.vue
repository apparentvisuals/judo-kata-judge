    ...
    <PrimeDataTable show-gridlines scrollable scroll-height="flex" row-group-mode="rowspan" group-rows-by="g"
      ...
      <PrimeColumnGroup type="header">
        <PrimeRow>
          ...
          <PrimeColumn header="S" class="w-12 kj-center" />
          <PrimeColumn header="S" class="w-12 kj-center" />
          <PrimeColumn v-if="!group.disableMajor" header="M" class="w-12 kj-center" />
          <PrimeColumn header="B" class="w-12 kj-center" />
          <PrimeColumn header="C" class="w-12 kj-center" />
          <PrimeColumn v-if="!group.disableForgotten" header="F" class="w-12 kj-center" />
